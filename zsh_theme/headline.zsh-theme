...
declare -A HL_CONTENT_TEMPLATE=(
  USER   "%{$bold$light_red%}..." # consider ' ' or ' '
  HOST   "%{$bold$light_yellow%}..." # consider '󰇅 ' or ' '
  VENV   " %{$bold$light_green%}..." # consider ' ' or ' '
  PATH   "%{$bold$light_blue%}..." # consider ' ' or ' '
  BRANCH " %{$bold$light_cyan%}..." # consider ' ' or ' '
  STATUS "%{$bold$light_magenta%}..."
  # ...
)
